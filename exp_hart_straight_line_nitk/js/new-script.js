...
// monitoring change in value and connecting slider and number
// setting trace point coordinate arrays to empty on change of link length
$( "#AEslider" ).on( "slide", function( e, ui ) { $('#AEspinner').spinner("value",ui.value); ptx=[]; pty=[]; } );
$( "#AEspinner" ).on( "spin", function( e, ui ) { $('#AEslider').slider("value",ui.value); ptx=[]; pty=[]; } );
$( "#AEspinner" ).on( "change", function() {  varchange() } );
...
// monitoring change in value and connecting slider and number
// setting trace point coordinate arrays to empty on change of link length
$( "#AQslider" ).on( "slide", function( e, ui ) { $('#AQspinner').spinner("value",ui.value); ptx=[]; pty=[]; } );
$( "#AQspinner" ).on( "spin", function( e, ui ) { $('#AQslider').slider("value",ui.value); ptx=[]; pty=[]; } );
$( "#AQspinner" ).on( "change", function() {  varchange() } );
...
// monitoring change in value and connecting slider and number
// setting trace point coordinate arrays to empty on change of link length
$( "#EBslider" ).on( "slide", function( e, ui ) { $('#EBspinner').spinner("value",ui.value); ptx=[]; pty=[]; } );
$( "#EBspinner" ).on( "spin", function( e, ui ) { $('#EBslider').slider("value",ui.value); ptx=[]; pty=[]; } );
$( "#EBspinner" ).on( "change", function() {  varchange() } );
...
if(((la*la+le*le-lb*lb)/(2*la*le))>=-1 && ((la*la+le*le-lb*lb)/(2*la*le))<=1)
{
...
printcomment("Mechanism will stop functioning when linkage combination will not allow movement",0)
