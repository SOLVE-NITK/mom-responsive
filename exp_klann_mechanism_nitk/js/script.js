...
var r1 = 50, r2 = 2.6928 * r1, rb = r2, r3 = 1.1818 * r1, r4 = 2.0182 * r1, r5 = 2.4091 * r1, r6 = 1.6554 * r1;
...
function varupdate() {
    ...
    printcomment("This is the Mechanism is used as a simple Walking mechanism with only 1 DOF", 1);
    ...
    r2 = 2.6928 * r1, rb = r2, r3 = 1.1818 * r1, r4 = 2.0182 * r1, r5 = 2.4091 * r1, r6 = 1.6545 * r1, r7 = 4.4545 * r1;
    ...
    rv = Math.sqrt((c.xcoord - f.xcoord) * (c.xcoord - f.xcoord) + (c.ycoord - f.ycoord) * (c.ycoord - f.ycoord));
