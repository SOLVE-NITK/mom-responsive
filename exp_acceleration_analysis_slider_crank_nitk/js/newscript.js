...
printcomment("Acceleration Diagram (at &theta;<sub>2</sub> ="+theta2+"&deg;)",1);
}
...
//displaying scale values
  ...
  if(scaleV>=1)
  ctx.fillText("Scale = 1:"+scaleV,315,30);
  if(scaleV<1)
  ctx.fillText("Scale = "+1/scaleV+":1",315,30);

  if(scaleA>=1)
  ctx.fillText("Scale = 1:"+scaleA,425,180);
  if(scaleA<1)
  ctx.fillText("Scale = "+1/scaleA+":1",425,180);
  ctx.restore();
...
document.getElementById("va").style.left = ""+(-10+Math.round(60+vo.xcoord+va.xcoord)/2)+"px";
document.getElementById("va").style.top = ""+(-10+Math.round(200+vo.ycoord+va.ycoord)/2)+"px";
document.getElementById("vba").style.left = ""+(-10+Math.round(60+vba.xcoord+va.xcoord)/2)+"px";
document.getElementById("vba").style.top = ""+(-10+Math.round(200+vba.ycoord+va.ycoord)/2)+"px";
document.getElementById("vb").style.left = ""+(-10+Math.round(60+vb.xcoord+vo.xcoord)/2)+"px";
document.getElementById("vb").style.top = ""+(-10+Math.round(200+vb.ycoord+vo.ycoord)/2)+"px";
