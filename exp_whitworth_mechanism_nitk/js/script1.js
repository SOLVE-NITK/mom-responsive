...
function draw()
{
  ...
  document.getElementById('titleincanvas').innerHTML="<b>Position Analysis</b>";
...
function drawvel(ctx)
{
  ...
  document.getElementById('titleincanvas').innerHTML="<b>Velocity Analysis</b>";
...
function drawacc(ctx)
{
  ...
  document.getElementById('titleincanvas').innerHTML="<b>Acceleration Analysis</b>";
  document.getElementById('scale').innerHTML="Scale: "+scale+":1";
  scale=1;
  $('#datatable2').hide();
